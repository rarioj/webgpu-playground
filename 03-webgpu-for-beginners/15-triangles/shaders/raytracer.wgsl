...
fn intersectRayTriangle(ray: Ray, triangle: ObjectStructure, tMin: f32, tMax: f32, oldState: RenderState) -> RenderState {
    ...
    let edgeBA: vec3<f32> = -edgeAB;
    let edgeCA: vec3<f32> = -edgeAC;
    let edgeOriginA: vec3<f32> = triangleCornerA - ray.origin;
    ...
    var systemMatrix: mat3x3<f32> = mat3x3<f32>(ray.direction, edgeBA, edgeCA);
    ...
    systemMatrix = mat3x3<f32>(ray.direction, edgeOriginA, edgeCA);
    ...
    systemMatrix = mat3x3<f32>(ray.direction, edgeBA, edgeOriginA);
    ...
    // Edge B - A and edge A origin
    systemMatrix = mat3x3<f32>(edgeOriginA, edgeBA, edgeCA);
